...
## Workflow
	-SaveMult.C --> FitMultNBD.C --> CombinedEntropy.C --> PlotEntropies.C
...
## Files:
	...
	- `FitMultNBD.C` : Calculate the entropy of the multiplicity of the primaries separately and save it to a rootfile. The calculation is done directly on the histogram and based on a fit with a quadrupole of NBDs. These fits are not tuned, so in this sense don't make any sense. This is a test to see how different the entropy of the sum and the sum of the entropy of the multiplicities. We can avoid this later.
